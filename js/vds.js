!function t(e, r, n) {
    ...
    1: [function (t, e, r) {
        ...
        var S = new w, C = window.msSetImmediate;
        if (!C) {
            var O = [], N = String(Math.random());
            ...
            enqueue: function (t) {
                ...
                switch (t.stopImmediatePropagation(), t.type) {
                    ...
                    case"DOMNodeInserted":
                        ...
                        var c = d.previousSibling, f = d.nextSibling, i = h("childList", n);
        ...
        c = t("./utils"), s = c.detectIE() || 0 / 0, 9 > s ? t("json2") : (window.MutationObserver = t("mutation-observer"), a = t("tree-mirror")), u = t("./info"), c = t("./utils"), i = t("./messaging_observer"), o = t("./server_imp_setting"), d = c.detectIOS() || 0 / 0, n = function () {
            ...
            return s = null, O = 3, f = [], r = {}, p = {}, I = {
                ...
                if (d = [], g = !0, t.leaf) 1 === t.nodeType && ((null != (v = t.attributes) ? v.href : void 0) || null != t.text || null != t.obj) && (f = this.nodeMessage(t, !0), e > 1 && (f.idx = t.idx), d.push(f)); else if (t.isContainer && (f = this.nodeMessage(t, !0), d.push(f)), 0 === t.childNodes.length && -1 === c.indexOf(C, t.tagName)) ; else {
                    ...
                    if ((-1 !== c.indexOf(b, t.tagName) || g && ((null != (w = t.attributes) ? w.any : void 0) || t.text)) && (t.text || (i = t.dom, t.text = i ? u.containerElemContent(i) : c.parentOfLeafText(t)), f = this.nodeMessage(t, !1), d.push(f)), "SPAN" === t.tagName) for (y = t.childNodes, a = 0, l = y.length; l > a; a++) if (n = y[a], "svg" === n.tagName) for (S = n.childNodes, s = 0, p = S.length; p > s; s++) r = S[s], 1 === r.nodeType && "use" === r.tagName && c.hasAttr(r, "xlink:href") && (t.text = r.getAttribute("xlink:href"), f = this.nodeMessage(t, !1), d.push(f))
                }
                return d
                ...
                for (t in window.grcs) e[t] = window.grcs[t];
                if (r.pg) for (t in r) e[t] = r[t], p[t] = r[t]; else p = {};
                return r = {}, e
        ...
        u = t("./guid"), a = t("cookie"), f = t("./utils"), o = /(^| )(clear|clearfix|active|hover|enabled|hidden|display|focus|disabled|ng-|growing-)[^\. ]*/g, s = /\.?([a-zA-Z0-9\-]+\.[a-zA-Z]{2,6})$/, l = ["I", "SPAN", "EM", "svg"], d = f.detectIE() || 0 / 0, i = function () {
            ...
            user: function () {
                ...
                if (null == e && (e = !1), a = "", g = !1, n = {}, h = !1, c = !1, S = void 0, s = 0, y = [], o = [], t === document) return {isIgnore: !0};
                if (t.tagName) {
        ...
        if (t("./shim"), i = t("./tracker"), n = t("./dom_observer"), m = t("./utils"), h = t("./guid"), u = [], c = new n, v = new i(c), window._gr_support_circle_pop_out = !0, a = function () {
            ...
            for (null == window._vds && (window._vds = [["setAccountId", "22222-22222-22222-22222"]]), f = window._vds, l = 0, p = f.length; p > l; l++) s = f[l], "track" === (g = s[0]) ? u.push(s) : a.apply(null, s);
            window._vds = {
                push: function () {
        ...
        a = t("./utils"), o = ["load-plugin", "circle-mode", "browse-mode"], i = ["load-plugin", "register-iframe", "circle-mode", "browse-mode", "page-load", "circle-load"], n = function () {
            ...
            return t.prototype.bindEvents = function () {
                return a.bind(window, "message", function (t) {
                    return function (e) {
                        ...
                        if (r = e.data, r.ai === window.vds.accountId && (n = r.mode || r.circleMode, t.isSdkEvent(n) && (!r.fsna || "sdk" === r.fsna))) {
                            ...
                            if (i = r.mode, u.call(o, i) >= 0) a.spreadToInnerIframes(r); else if (r.tna !== window.grSource.name && r.tna && r.tid && a.isSpreadPostMessage()) return void a.spreadToInnerIframes(r);
                ...
                return r = {
                    ...
                    tna: "",
                    fsna: "sdk",
                    add_on_grSource: {grSource: window.grSource, vds: window.vds, add_on_origin: this.allowOrigin}
        ...
        u = t("lzstring"), h = t("./utils"), a = h.detectIE() || 0 / 0, d = navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./), o = d ? parseInt(d[2], 10) : !1, s = !1, o && 22 > o ? n = !1 : (n = !0, c = navigator.userAgent, "ArrayBufferView" in window || (-1 !== c.indexOf("Android") ? n = !1 : -1 !== c.indexOf("CPU OS ") ? -1 !== c.indexOf("CPU OS 6_") ? n = !1 : -1 !== c.indexOf("CPU OS 5_") ? n = !1 : -1 !== c.indexOf("CPU OS 4_") ? n = !1 : -1 !== c.indexOf("CPU OS 3_") && (n = !1) : -1 !== c.indexOf("CPU iPhone OS ") ? -1 !== c.indexOf("iPhone OS 6_") ? n = !1 : -1 !== c.indexOf("iPhone OS 5_") ? n = !1 : -1 !== c.indexOf("iPhone OS 4_") && (n = !1) : -1 !== c.indexOf("Intel Mac OS X") && (-1 !== c.indexOf("Mac OS X 10_6") ? n = !1 : -1 !== c.indexOf("Mac OS X 10_7") && (n = !1)))), i = function () {
            ...
            return e = [], i = [], r = [], t.prototype.connect = function (t) {
                ...
                try {
                    ...
                    return i = "pv" === e && 2 === t.length ? t[0].s : "", this.dispatchEvents(t), r = "undefined" == typeof Uint8Array || null === Uint8Array || s ? window.XMLHttpRequest && 7 !== a && !s ? u.compressToUTF16(JSON.stringify(t)) : u.compressToEncodedURIComponent(JSON.stringify(t)) : u.compressToUint8Array(JSON.stringify(t)), this.sendRemote(r, e, i)
                } catch (o) {
                    n = o
                }
        ...
        n = t("./sender"), a = t("./utils"), o = t("./info"), i = function () {
            ...
            return t.prototype.version = "0.7.25", t.prototype.scheme = "https://", t.prototype.host = "api.growingio.com", t.prototype.circleHost = ("https:" === document.location.protocol ? "https://" : "http://") + "www.growingio.com", t.prototype.endpoint = "/events", t.prototype.properties = {
                imp: !0,
                hashtag: !1,
                touch: !1,
                ignoreClck: !1,
                ...
                var e, r, i, o;
                window.vds = {origin: this.circleHost, version: this.version};
                ...
                return i = new n(this.user, this.getUrlMap(), t, this.dispathMessage2Listener), i.connect({isBot: !!e})
        ...
        var n = /^(\.co\.|\.com\.|\.org\.|\.edu\.|\.net\.)/, i = {
            ...
            getItem: i.getItem, hasItem: i.hasItem, keys: i.keys, setItem: function (t, e, r, o, a, s) {
        ...
        var n = function () {
            var t = String.fromCharCode, e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$", r = {
                compressToUTF16: function (e) {
                    ...
                    if (null == t) return "";
                    var n, i, o, a = {}, s = {}, u = "", d = "", c = "", h = 2, l = 3, p = 2, f = [], g = 0, v = 0;
                    for (o = 0; o < t.length; o += 1) if (u = t.charAt(o), Object.prototype.hasOwnProperty.call(a, u) || (a[u] = l++, s[u] = !0), d = c + u, Object.prototype.hasOwnProperty.call(a, d)) c = d; else {
                        ...
                        } else for (i = a[c], n = 0; p > n; n++) g = g << 1 | 1 & i, v == e - 1 ? (v = 0, f.push(r(g)), g = 0) : v++, i >>= 1;
        ...
        var h = function () {
            ...
            return t.prototype.getAttributeOldValue = function (t) {
                ...
                this.attributes = !0, this.attributeOldValues = this.attributeOldValues || {},
            ...
            return t.prototype.processMutations = function () {
                ...
                for (var a = this.stayedIn.keys(), n = 0; n < a.length; n++) {
                    ...
                    if (o === d.ENTERED) t.added.push(i); else if (o === d.EXITED) t.removed.push(i); else if (o === d.STAYED_IN && (t.reparented || t.reordered)) {
        ...
        }(), y = /^([a-zA-Z:_]+[a-zA-Z0-9_\-:\.]*)$/, S = function () {
            function t(e) {
                var r = this;
        ...
        var n = {
            ...
            a = ["button", "submit"], s = ["I", "SPAN", "EM", "svg"], u = ["A", "BUTTON"], d = function () {
                function t(t, e, r) {
                    if (t) {
                        var n = this;
                    ...
                    switch (1 === g.nodeType && -1 !== u.indexOf(t.tagName) && (g.dom = t), g.nodeType) {
                        ...
                        case 1:
                            ...
                            if (e += "/", w.childNodes.length > 0) {
                                ...
                                var S, C, O = 0, N = -1 !== u.indexOf(w.tagName);
                                if (N) for (var x = w.firstChild; x; x = x.nextSibling) if (1 === x.nodeType && -1 === s.indexOf(x.tagName)) {
                                    N = !1;
                                    break
                                }
                                for (var I = w.firstChild; I; I = I.nextSibling) {
                                    if (S = w.hasAttribute("data-growing-info") ? w.getAttribute("data-growing-info") : null, C = w.hasAttribute("data-growing-idx") ? parseInt(w.getAttribute("data-growing-idx")) : -1, 1 === I.nodeType) {
                                        ...
                                        if (N && -1 !== s.indexOf(I.tagName) && (y = !1, !I.children || 0 === I.children.length)) continue;
                                        -1 !== i.indexOf(I.tagName) && (O += 1, C = O), I.hasAttribute("data-growing-idx") && (O = parseInt(I.getAttribute("data-growing-idx")), C = O), I.hasAttribute("data-growing-info") && (S = I.getAttribute("data-growing-info"))
                                    }
                                    var E = this.serializeNode(I, e, O > 0 && C > 0 ? O : r, S || d);
                                    if (null === E) 3 != I.nodeType && (y = !1); else if ("undefined" != typeof E.childNodes) {
                                        y = !1, b = !0;
                                        for (var A = 0; A < E.childNodes.length; A++) if (E.childNodes[A].tagName) {
                                            b = !1;
                                            break
                                        }
                            ...
                            if (y) if (g.leaf = !0, "IMG" === w.tagName && (delete g.attributes.href, w.src && -1 === w.src.indexOf("data:image") && (g.attributes.href = w.src)), w.hasAttribute("data-growing-title") && w.getAttribute("data-growing-title").length > 0) g.text = w.getAttribute("data-growing-title"); else if (w.hasAttribute("title") && w.getAttribute("title").length > 0) g.text = w.getAttribute("title"); else if ("IMG" === w.tagName) {
                                ...
                                if (w.hasAttribute("data-growing-title") && w.getAttribute("data-growing-title").length > 0) g.text = w.getAttribute("data-growing-title"); else if (w.hasAttribute("title") && w.getAttribute("title").length > 0) g.text = w.getAttribute("title"); else if ("svg" === w.tagName) for (var k = w.firstChild; k; k = k.nextSibling) if ("use" === k.tagName && k.getAttribute("xlink:href")) {
                                    g.text = k.getAttribute("xlink:href");
                                    break
                                }
